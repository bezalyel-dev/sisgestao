    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
      {cards.map((card) => {
        ...
        return (
          <div
            key={card.title}
            className="bg-white border border-gray-200 rounded-lg shadow-md lg:shadow-lg p-4 lg:p-6 hover:shadow-xl transition-all duration-200"
          >
            <div className="flex items-center justify-between mb-3 lg:mb-4">
              <h3 className="text-xs lg:text-sm font-medium text-gray-700">{card.title}</h3>
